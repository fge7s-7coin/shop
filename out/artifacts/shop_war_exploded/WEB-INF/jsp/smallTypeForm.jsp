                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="padding: 15px;">
                            <form class="layui-form" action="/smalltype/add" method="post"
                                ...
                                <input class="form-control" type="hidden" name="id" value="${smallTypelist.id}">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">大商品ID</label>
                                    <div class="layui-input-block">
                                        <input type="text" name=" bigTypeId" lay-verify="required" placeholder="商品ID"
                                               autocomplete="off" class="layui-input" value="${smallTypelist.bigTypeId }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="typeName" lay-verify="required" placeholder="商品名称"
                                               autocomplete="off" class="layui-input" value="${smallTypelist.typeName }">
                                    </div>
                                </div>
