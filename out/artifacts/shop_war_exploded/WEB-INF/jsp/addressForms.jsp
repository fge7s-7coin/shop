                ...
                <div class="layui-fluid">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="padding: 15px;">
                            <form class="layui-form" action="/address/add" method="post"
                                  lay-filter="component-form-group">
                                <input class="form-control" type="hidden" name="id" value="${address.id}">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">姓名</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="consignee" lay-verify="required" placeholder="姓名"
                                               autocomplete="off" class="layui-input" value="${address.consignee }">
                                    </div>
                                </div>
