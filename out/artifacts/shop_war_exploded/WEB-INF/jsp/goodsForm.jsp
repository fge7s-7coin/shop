                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="padding: 15px;">
                            <form class="layui-form" action="/goods/add" method="post"
                                ...
                                <input class="form-control" type="hidden" name="id" value="${goodsformlist.id}">
                               <div class="layui-form-item">
                                    <label class="layui-form-label">商品名称</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="goodsName" lay-verify="required" placeholder="商品名称"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.goodsName }">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="price" lay-verify="required|tel" placeholder="商品价格"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.price }">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="describtion" lay-verify="required" placeholder="商品描述"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.describtion }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="num" lay-verify="required" placeholder="商品数量"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.num }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="picture" lay-verify="required" placeholder="图片地址"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.picture }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="manufacturer" lay-verify="required" placeholder="生产厂家"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.manufacturer }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="smallTypeId" lay-verify="required" placeholder="商品类别"
                                               autocomplete="off" class="layui-input" value="${goodsformlist.smallTypeId }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select id="state" name="state">
                                            ...
                                            <option value="0" ${goodsformlist.state==0?'selected':'' }>上架</option>
                                            <option value="1" ${goodsformlist.state==1?'selected':'' }>下架</option>
                                ...
                                <div class="layui-input-block">
                                    <select id="score" name="score">
                                        ...
                                        <option value="0" ${goodsformlist.score==0?'selected':'' }>1</option>
                                        <option value="1" ${goodsformlist.score==1?'selected':'' }>2</option>
