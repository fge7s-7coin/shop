                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="padding: 15px;">
                            <form class="layui-form" action="/shopcar/add" method="post"
                                ...
                                <input class="form-control" type="hidden" name="id" value="${shopcarlist.id}">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">商品ID</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="goodsId" lay-verify="required" placeholder="商品ID"
                                               autocomplete="off" class="layui-input" value="${shopcarlist.goodsId }">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="userId" lay-verify="required|tel" placeholder="用户ID"
                                               autocomplete="off" class="layui-input" value="${shopcarlist.userId }">
                                    </div>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="num" lay-verify="required" placeholder="商品数量"
                                               autocomplete="off" class="layui-input" value="${shopcarlist.num }">
                                    </div>
                                </div>
