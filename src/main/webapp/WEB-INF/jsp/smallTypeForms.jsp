                ...
                <div class="layui-fluid">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="padding: 15px;">
                            <form class="layui-form" action="/smalltype/add" method="post"
                                  lay-filter="component-form-group">
                                <input class="form-control" type="hidden" name="id" value="${smalltype.id}">

                                <div class="layui-form-item">
                                    <label class="layui-form-label">大类型ID</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="bigTypeId" lay-verify="required" placeholder="大类型ID"
                                               autocomplete="off" class="layui-input" value="${smalltype.bigTypeId }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">小商品类型</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="typeName" lay-verify="required" placeholder="小商品类型名"
                                               autocomplete="off" class="layui-input" value="${smalltype.typeName }">
                                    </div>
                                </div>
