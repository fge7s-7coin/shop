                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="padding: 15px;">
                            <form class="layui-form" action="/ord/add" method="post"
                                ...
                                <input class="form-control" type="hidden" name="id" value="${ordlist.id}">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">商品ID</label>
                                    <div class="layui-input-block">
                                        <input type="text" name=" goodsId" lay-verify="required" placeholder="商品ID"
                                               autocomplete="off" class="layui-input" value="${ordlist.goodsId }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="userId" lay-verify="required" placeholder="用户ID"
                                               autocomplete="off" class="layui-input" value="${ordlist.userId }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">地址ID</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="addressId" lay-verify="required" placeholder="地址ID"
                                               autocomplete="off" class="layui-input" value="${ordlist.addressId }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="num" lay-verify="required" placeholder="商品数量"
                                               autocomplete="off" class="layui-input" value="${ordlist.num }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">商品价格</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="price" lay-verify="required" placeholder="商品价格"
                                               autocomplete="off" class="layui-input" value="${ordlist.price }">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label">订单编号</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="ordNo" lay-verify="required" placeholder="订单编号"
                                               autocomplete="off" class="layui-input" value="${ordlist.ordNo }">
                                    </div>
                                </div>
